...
public class LabelTooltip implements ITooltip
{
    ...
    public void drawTooltip(GuiContext context)
    {
        ...
        List<IReorderingProcessor> strings = context.font.trimStringToWidth(label, this.width);
        ...
        int w = strings.size() == 1 ? context.font.getStringWidth(strings.get(0).toString()) : this.width;
        ...
        for (IReorderingProcessor line : strings)
        {
            context.font.drawString(new MatrixStack(), line.toString(), x, y, 0x000000);
